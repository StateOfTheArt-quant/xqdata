...
class DataProxy(TradingDatesMixin):
    ...
    def history_bars(self, order_book_ids, bar_count, dt, fields=None, frequency='1d',skip_suspended=False, include_now=True, adjust_type="pre", adjust_orig=None):
    ...
    def history_fundamentals(self, order_book_ids, bar_count, dt, fields=None, frequency='1d',skip_suspended=False, include_now=True, adjust_type="pre", adjust_orig=None):
    ...
    def history_tradings(self, order_book_ids, bar_count, dt, fields=None, frequency='1d',skip_suspended=False, include_now=True, adjust_type="pre", adjust_orig=None):
